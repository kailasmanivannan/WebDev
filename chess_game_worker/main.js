    ...
    if (isPieceSet === 0) {
      ...
      if (currentPiece.side === "white") {
        switch (currentPiece.pieceName) {
          case "PAWN":
            myWorker = new Worker("./modules/pawnSet.js");
            myWorker.postMessage([id, currentPiece.side]);
            ...
            break;
          case "ROOK":
            myWorker = new Worker("./modules/rookSet.js");
            myWorker.postMessage([boardData,id]);
            myWorker.onmessage = function(e){
              validMoves = e.data;
            }
            oldIndex = id;
            break;
          case "KNIGHT":
            myWorker = new Worker("./modules/knightSet.js");
          ...
          case "QUEEN":
            // validMoves =[];
            // myWorker = new Worker("./modules/bishopSet.js");
            // myWorker.postMessage([boardData,id]);
            // myWorker.onmessage = function(e){
            //   validMoves.push(...e.data);
            //   // console.log(...e.data);
            // }
            // myWorker = new Worker("./modules/rookSet.js");
            // myWorker.postMessage([boardData,id]);
            ...
            // oldIndex = id;
            // }
            myWorker = new Worker('./modules/queenSet.js');
            myWorker.postMessage([boardData,id]);
            myWorker.onmessage = function(e){
              validMoves = e.data;
              console.log(validMoves);
          ...
          case "BISHOP":
            ...
            break;
          case "KING":
            myWorker = new Worker("./modules/kingSet.js");
            myWorker.postMessage(id);
            myWorker.onmessage = function(e){
              validMoves = e.data;
            }
